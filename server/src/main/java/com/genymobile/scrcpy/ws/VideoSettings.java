...
public class VideoSettings {
    ...
    public byte[] toByteArray() {
        ...
        if (codecOptionsString != null) {
            codeOptionsBytes = codecOptionsString.getBytes(StandardCharsets.UTF_8);
            additionalLength += codeOptionsBytes.length;
        }
        byte[] encoderNameBytes = new byte[]{};
        if (encoderName != null) {
            encoderNameBytes = encoderName.getBytes(StandardCharsets.UTF_8);
    ...
    public boolean equals(Object o) {
        ...
        if (bitRate != s.bitRate || maxFps != s.maxFps || lockedVideoOrientation != s.lockedVideoOrientation
